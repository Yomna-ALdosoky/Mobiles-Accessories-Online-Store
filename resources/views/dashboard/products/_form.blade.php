...
<div class="form-group">
    ...
    <select name="parent_id" class="form-control form-select">
        ...
        <option value="{{$category->id}}" @selected(old('parent_id', $category->parent_id) ==
...
<div class="form-group">
    <x-form.input label="Compare Price" class="form-control-lg" role="input" name="compare price"
