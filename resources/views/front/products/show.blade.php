                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="images">
                                    <img src="https://www.opelgtsource.com/assets/default_product.png" class="img"
                                        alt="#">
                                    <img src="https://www.opelgtsource.com/assets/default_product.png" class="img"
                                        alt="#">
                                    <img src="https://www.opelgtsource.com/assets/default_product.png" class="img"
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{ Currency::format($product->price) }}
                                @if($product->compare_price)<span>{{
                                    Currency::format($product->compare_price) }}</span>@endif</h3>
